...
import vn.loitp.app.activity.customviews.viewpager.placeholderview._lib.placeholderview.listeners.ItemRemovedListener;
...
public class SwipePlaceHolderView extends FrameLayout implements
    ...
    public void onAnimateView(float distXMoved,
        ...
        LayoutParams layoutParams =
                (LayoutParams) swipeViewBinder.getLayoutView().getLayoutParams();
