...
public class UizaDrawerMenuItemV1 {
    //@Position
    ...
    public UizaDrawerMenuItemV1(Context context, List<Item> itemList, int pos, Callback callback) {
    ...
    private void onResolved() {
        ...
        if (mPos == HomeDataV1.getInstance().getCurrentPosition()) {
