...
public final class DebugTextViewHelper implements Runnable, Player.EventListener {
    ...
    private void updateAndPost() {
        String log = getPlayerStateString() + getPlayerWindowIndexString() + getVideoString() + getAudioString();
        //Log.d("loitp", ">updateAndPost: " + log);
    ...
    private String getPlayerStateString() {
        ...
        //Log.d("loitp", ">getPlayerStateString: " + text);
